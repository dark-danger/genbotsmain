...
SCHOOL_LAB_DATA = [
    ...
    {"name": "12V 2200mAh 3S LiPo Battery (3 Cell)", "price": 1850.0, "category_slug": "electronics-components", "image": "/products/lipo-battery-2200mah-3s.jpg", "desc": "High performance 11.1V 2200mAh 3-Cell 80C LiPo battery pack with XT60 connector for RC quadcopters, drones, and heavy robotics."},
    {"name": "B3 Pro Compact LiPo Battery Charger", "price": 450.0, "category_slug": "electronics-components", "image": "/products/lipo-battery-b3-charger.jpg", "desc": "Automatic AC 100-240V balance compact charger for 2S and 3S 7.4V / 11.1V LiPo batteries with LED charge status indicators."},
    {"name": "Self-Adjusting Automatic Wire Stripper", "price": 250.0, "category_slug": "stem-kits", "image": "/products/automatic-wire-stripper.jpg", "desc": "Self-adjusting heavy duty multi-gauge automatic wire stripper, cutter, and crimper for electronics and robotics wiring."},
    {"name": "DT-830D Digital Multimeter with Probes", "price": 350.0, "category_slug": "stem-kits", "image": "/products/dt830d-digital-multimeter.jpg", "desc": "Digital LCD multimeter with test lead probes for measuring DC/AC voltage, current, resistance, diode, and continuity."},
